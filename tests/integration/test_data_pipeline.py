...
from tinycti import TinyCTI, IOC, IOCType, RetentionBucket
...
class TestDataPipeline:
    ...
    def pipeline_config(self, temp_directory):
        ...
        return {
            ...
            "logging": {
                "level": "DEBUG",
                "file": str(temp_directory / "pipeline.log")
            }
        }
    ...
    def test_complete_data_pipeline_flow(self, pipeline_config):
        ...
        with requests_mock.Mocker() as m:
            # Mock des feeds
            m.get("http://feeds.example.com/ipv4.txt", 
                  text="192.168.1.1\n10.0.0.1\n172.16.1.1\n192.168.1.1")  # Avec doublon
            m.get("http://feeds.example.com/domains.txt",
                  text="malicious.com\nexample.org\ntest.net\nmalicious.com")  # Avec doublon
            m.get("http://feeds.example.com/hashes.txt",
...
""".strip()
    ...
    def test_incremental_data_updates(self, pipeline_config):
        ...
        with requests_mock.Mocker() as m:
            ...
            m.get("http://feeds.example.com/hashes.txt", text="d41d8cd98f00b204e9800998ecf8427e")
            ...
            m.get("http://feeds.example.com/ipv4.txt", text="192.168.1.1\n172.16.1.1")  # 1 nouveau
            m.get("http://feeds.example.com/domains.txt", text="example.com\nmalicious.net")  # 1 nouveau
            m.get("http://feeds.example.com/hashes.txt", text="d41d8cd98f00b204e9800998ecf8427e\n5d41402abc4b2a76b9719d911017c592")  # 1 nouveau
    ...
    def test_data_retention_pipeline(self, pipeline_config):
        ...
        with patch.object(tinycti.retention_manager, '_find_iocs_for_transition') as mock_find:
    ...
    def test_data_deduplication_across_feeds(self, pipeline_config):
        ...
        with requests_mock.Mocker() as m:
            ...
            m.get("http://feeds.example.com/ipv4.txt", text="192.168.1.1\n10.0.0.1")
            m.get("http://feeds.example.com/domains.txt", text="192.168.1.1\nexample.com")  # IP dupliquée
            m.get("http://feeds.example.com/hashes.txt", text="example.com\nd41d8cd98f00b204e9800998ecf8427e")  # Domaine dupliqué
    ...
    def test_data_priority_handling(self, pipeline_config):
        ...
        test_iocs = [
            IOC("priority.test", IOCType.DOMAIN, "feed3", RetentionBucket.FROID),  # Priorité faible
            IOC("priority.test", IOCType.DOMAIN, "feed1", RetentionBucket.LIVE),   # Priorité élevée
            IOC("priority.test", IOCType.DOMAIN, "feed2", RetentionBucket.CHAUD),  # Priorité moyenne
        ]
        ...
        stored_domains = tinycti.storage.get_iocs_by_type("domain")
        priority_ioc = next((ioc for ioc in stored_domains if ioc["value"] == "priority.test"), None)
