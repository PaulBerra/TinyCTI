...
from tinycti import (ConfigurationError, ConfigurationLoader,
                     LoggingConfigurator)
...
class TestConfigurationLoader:
    ...
    def test_load_config_file_not_found(self, temp_directory):
        ...
        with pytest.raises(
            ConfigurationError, match="Fichier de configuration non trouvé"
        ):
            loader.load_config()
    ...
    def test_validate_invalid_feed_type(self, temp_directory):
        ...
        invalid_config = {
            "feeds": [
                {"name": "test", "type": "invalid_type", "url": "http://example.com"}
            ],
            "output_dir": "test",
        }
    ...
    def test_validate_invalid_url(self, temp_directory):
        ...
        invalid_config = {
            "feeds": [{"name": "test", "type": "text", "url": "not_a_valid_url"}],
            "output_dir": "test",
        }
    ...
    def test_default_values_applied(self, temp_directory):
        ...
        minimal_config = {
            "feeds": [{"name": "test", "type": "text", "url": "http://example.com"}],
            "output_dir": "test",
        }
