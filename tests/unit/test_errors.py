...
from tinycti import (CircuitBreaker, ConfigurationError, ErrorHandler,
                     StorageError)
...
class TestCircuitBreaker:
    ...
    def test_circuit_breaker_with_args_and_kwargs(self):
        ...
        result = breaker.call(
            function_with_params, "arg1", "arg2", c="kwarg1", d="kwarg2"
        )
    ...
    def test_circuit_breaker_exception_types(self):
        ...
        for i, exc in enumerate(
            exceptions[:2]
        ):  # Seulement les 2 premiers pour ne pas ouvrir le circuit
...
class TestErrorIntegration:
    ...
    def test_error_handler_with_circuit_breaker(self, mock_logger):
        ...
        result4 = protected_operation(
            should_fail=False
        )  # Même si ne devrait pas échouer
